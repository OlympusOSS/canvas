...
import { type StepperStep, WizardShell } from "../src/index";
...
describe("WizardShell", () => {
	...
	it("renders the footer slot when provided", () => {
		render(
			<WizardShell steps={STEPS} activeStep="s1" footer={<div data-testid="footer">f</div>}>
				<p>x</p>
			</WizardShell>,
		);
	...
	it("renders a terminal toggle and content when terminal is provided", () => {
		render(
			<WizardShell steps={STEPS} activeStep="s1" terminal={<div data-testid="term">logs</div>}>
				<p>x</p>
			</WizardShell>,
		);
	...
	it("matches snapshot", () => {
		const { container } = render(
			<WizardShell steps={STEPS} activeStep="s1" sidebarHeader={<span>brand</span>}>
				<p>content</p>
			</WizardShell>,
		);

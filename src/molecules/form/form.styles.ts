...
// labels read at 14sp with positive body-medium tracking (+0.25); supporting
// (helper) text is M3 body-small (12sp / +0.4 tracking); fields stack with the M3
// vertical rhythm (16 / 24, matching the field-density spacing). The section
// heading bumps to M3 title weight (600).
export const androidSkin: FormSkin = {
  label: (t: ColorTokens): TextStyle => ({ fontSize: 14, lineHeight: 20, fontWeight: "500", letterSpacing: 0.25, color: t.foreground }),
  helper: (t: ColorTokens): TextStyle => ({ marginTop: 6, fontSize: 12, lineHeight: 16, letterSpacing: 0.4, color: t["muted-foreground"] }),

...
/**
 * The standard Tailwind v3 color-hue palette, scheme-independent. Backs the
 * bg-* / text-* / border-* utilities for color-coded components that need hues
 * beyond the semantic tokens. Keyed "<hue>-<step>" (e.g. "red-500"), values are
 * the canonical Tailwind v3 hexes, lowercase.
 */

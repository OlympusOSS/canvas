...
2. `cd docs-next && eas init` — links the repo to an Expo project (writes the project id into the config)
...
- The web docs at `../docs/` (Vite) remain the production web site; this app is the
  native deliverable and a parity-capable universal web build.

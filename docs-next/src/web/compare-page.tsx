...
import { RAW } from "docs-core/raw-md";

// The Vite Compare page, reused verbatim for web parity — only its component-markdown
// source changes: the Vite original used import.meta.glob; here the same map comes from
// the generated docs-core/raw-md (keyed identically). Reference imagery still loads from
// /refs/... (gitignored, captured locally), exactly as on the Vite site.

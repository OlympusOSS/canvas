...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Palette,
    items: [
      { slug: "tokens-colors", label: "Colors & Theme", to: "/tokens/colors", icon: Palette },
      ...
      { slug: "tokens-layout", label: "Layout & Flexbox", to: "/tokens/layout", icon: LayoutGrid },
    ],
  },
  {
    label: "Guides",
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "toggle", label: "Toggles", to: "/components/toggle", icon: ToggleLeft },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "navigation", label: "Navigation", to: "/components/navigation", icon: Navigation },

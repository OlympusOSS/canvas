...

  {
    ...
    playground: {
      ...
      render: (s) => {
        ...
        if (s.variant === "split") {
          return `<div class="btn-group"><button class="btn btn-default${sz}" style="border-top-right-radius:0;border-bottom-right-radius:0">Save</button><button class="btn btn-default${sz}" style="border-top-left-radius:0;border-bottom-left-radius:0;border-left:1px solid hsl(var(--primary-foreground)/0.2);padding-inline:0.5rem"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></button></div>`;
        }
        if (s.variant === "attached") {
          return `<div class="btn-group">${labels.map((l, i) =>

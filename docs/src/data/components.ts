...
export const COMPONENTS: ComponentManifestEntry[] = [
	...
	{ id: "launcher-card", label: "LauncherCard", tier: "molecules" },
	...
	{ id: "terminal", label: "Terminal", tier: "molecules" },
	...
	// charts
	{ id: "activity-heatmap", label: "ActivityHeatmap", tier: "charts" },
	...
	{ id: "service-health-list", label: "ServiceHealthList", tier: "charts" },
	{ id: "sparkline", label: "Sparkline", tier: "charts" },
	{ id: "stacked-bar", label: "StackedBar", tier: "charts" },

...
import e_atoms_combobox_dont_1_dont from "./examples/atoms/combobox/dont-1-dont";
import e_atoms_combobox_dont_2_do from "./examples/atoms/combobox/dont-2-do";
import e_atoms_combobox_dont_2_dont from "./examples/atoms/combobox/dont-2-dont";
import e_atoms_combobox_dont_3_do from "./examples/atoms/combobox/dont-3-do";
import e_atoms_combobox_dont_3_dont from "./examples/atoms/combobox/dont-3-dont";
import e_atoms_combobox_dont_4_do from "./examples/atoms/combobox/dont-4-do";
import e_atoms_combobox_dont_4_dont from "./examples/atoms/combobox/dont-4-dont";
import e_atoms_combobox_dont_5_do from "./examples/atoms/combobox/dont-5-do";
import e_atoms_combobox_dont_5_dont from "./examples/atoms/combobox/dont-5-dont";
...
import e_organisms_stepper_example_0 from "./examples/organisms/stepper/example-0";
import e_organisms_stepper_example_1 from "./examples/organisms/stepper/example-1";
import e_organisms_stepper_example_2 from "./examples/organisms/stepper/example-2";
import e_organisms_stepper_dont_0_do from "./examples/organisms/stepper/dont-0-do";
import e_organisms_stepper_dont_0_dont from "./examples/organisms/stepper/dont-0-dont";
import e_organisms_stepper_dont_1_do from "./examples/organisms/stepper/dont-1-do";
import e_organisms_stepper_dont_1_dont from "./examples/organisms/stepper/dont-1-dont";
import e_organisms_stepper_dont_2_do from "./examples/organisms/stepper/dont-2-do";
import e_organisms_stepper_dont_2_dont from "./examples/organisms/stepper/dont-2-dont";
...
export const COMPONENT_DOCS: Record<string, DocEntry> = {
  "avatar": {
    ...
    donts: [
      ...
      { title: "Identity", do: { caption: "Name primary; email muted and secondary.", code: "<Row relaxed alignCenter>\n  <Avatar src=\"/rachel-chen.jpg\" name=\"RC\" />\n  <Column>\n    <Typography lead semibold>Rachel Chen</Typography>\n    <Typography small muted>rachel.chen@example.com</Typography>\n  </Column>\n</Row>", render: e_atoms_avatar_dont_3_do }, dont: { caption: "Equal weight on the name and email flattens the hierarchy.", code: "<View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 16 }}>\n  <Avatar src=\"/rachel-chen.jpg\" name=\"RC\" />\n  <View>\n    <Text style={{ fontSize: 14, lineHeight: 20, color: tokens.foreground }}>Rachel Chen</Text>\n    <Text style={{ fontSize: 14, lineHeight: 20, color: tokens.foreground }}>rachel.chen@example.com</Text>\n  </View>\n</View>", render: e_atoms_avatar_dont_3_dont } },
      { title: "Menu header", do: { caption: "Keep one consistent circular avatar shape across contexts.", code: "<Row cozy alignCenter>\n  <Avatar src=\"/ada-lovelace.jpg\" name=\"AL\" />\n  <Column>\n    <Typography small semibold>Ada Lovelace</Typography>\n    <Typography tiny muted>admin@example.com</Typography>\n  </Column>\n</Row>", render: e_atoms_avatar_dont_4_do }, dont: { caption: "Squaring the avatar here clashes with the circular avatars everywhere else.", code: "<View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 12 }}>\n  <Avatar rounded src=\"/ada-lovelace.jpg\" name=\"AL\" />\n  <View>\n    <Text style={{ fontSize: 14, lineHeight: 20, fontWeight: \"600\", color: tokens.foreground }}>Ada Lovelace</Text>\n    <Text style={{ fontSize: 12, lineHeight: 16, color: tokens[\"muted-foreground\"] }}>admin@example.com</Text>\n  </View>\n</View>", render: e_atoms_avatar_dont_4_dont } },
    ],
  },
  "badge": {
    dir: "badge",
    ...
    examples: [
      ...
      { label: "Type - status", code: "<Badge status success>admin</Badge>", render: e_atoms_badge_example_1 },
      { label: "Type - identity", code: "<Row wrap alignCenter snug>\n  <Typography lead semibold>Rachel Chen</Typography>\n  <Badge status success>active</Badge>\n  <Badge status info>Verified</Badge>\n  <Badge secondary>employee</Badge>\n</Row>", render: e_atoms_badge_example_2 },
      { label: "Type - grants", code: "<Row wrap tight>\n  <Badge secondary mono>authorization_code</Badge>\n  <Badge secondary mono>refresh_token</Badge>\n  <Badge secondary mono>client_credentials</Badge>\n</Row>", render: e_atoms_badge_example_3 },
      { label: "Badge variant - default", code: "<Badge default>admin</Badge>", render: e_atoms_badge_example_4 },
      { label: "Badge variant - outline", code: "<Badge outline>admin</Badge>", render: e_atoms_badge_example_5 },
      { label: "Badge variant - destructive", code: "<Badge destructive>admin</Badge>", render: e_atoms_badge_example_6 },
    ...
    donts: [
      ...
      { title: "Status badge", do: { caption: "Always pair the dot with a word: active, pending, failed.", code: "<Badge status error>Failed</Badge>", render: e_atoms_badge_dont_1_do }, dont: { caption: "A bare colored dot isn't a label and fails for color-blind users.", code: "<Badge status error />", render: e_atoms_badge_dont_1_dont } },
      { title: "Identity row", do: { caption: "Show only the one or two badges relevant to this view.", code: "<Row wrap alignCenter snug>\n  <Typography lead semibold>Rachel Chen</Typography>\n  <Badge status success>active</Badge>\n  <Badge secondary>employee</Badge>\n</Row>", render: e_atoms_badge_dont_2_do }, dont: { caption: "A wall of badges after a name buries the one that matters.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", alignItems: \"center\", gap: 8 }}>\n  <Text style={{ fontSize: 15, fontWeight: \"600\", color: tokens.foreground }}>Rachel Chen</Text>\n  <Badge status success>active</Badge>\n  <Badge status info>Verified</Badge>\n  <Badge secondary>employee</Badge>\n  <Badge secondary>engineering</Badge>\n  <Badge secondary>remote</Badge>\n  <Badge secondary>admin</Badge>\n</View>", render: e_atoms_badge_dont_2_dont } },
      { title: "Token / code badge", do: { caption: "Use the mono variant for tokens, scopes, and event names.", code: "<Row wrap tight>\n  <Badge secondary mono>authorization_code</Badge>\n  <Badge secondary mono>refresh_token</Badge>\n  <Badge secondary mono>client_credentials</Badge>\n</Row>", render: e_atoms_badge_dont_3_do }, dont: { caption: "Proportional type makes identifiers hard to scan and compare.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", gap: 4 }}>\n  <Badge secondary>authorization_code</Badge>\n  <Badge secondary>refresh_token</Badge>\n  <Badge secondary>client_credentials</Badge>\n</View>", render: e_atoms_badge_dont_3_dont } },
      { title: "Default variant", do: { caption: "Reserve the default fill for the single tag you want noticed first; keep the rest secondary.", code: "<Row wrap alignCenter snug>\n  <Badge default>admin</Badge>\n  <Badge secondary>engineering</Badge>\n  <Badge secondary>remote</Badge>\n</Row>", render: e_atoms_badge_dont_4_do }, dont: { caption: "The solid primary fill is the loudest badge; using it for every tag makes the whole row shout and nothing leads.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", alignItems: \"center\", gap: 6 }}>\n  <Badge default>employee</Badge>\n  <Badge default>engineering</Badge>\n  <Badge default>remote</Badge>\n  <Badge default>admin</Badge>\n</View>", render: e_atoms_badge_dont_4_dont } },
      { title: "Secondary variant", do: { caption: "Keep secondary for static metadata (role, team) and switch to the status-badge for anything live.", code: "<Row wrap alignCenter snug>\n  <Badge secondary>employee</Badge>\n  <Badge secondary>engineering</Badge>\n  <Badge status success>active</Badge>\n</Row>", render: e_atoms_badge_dont_5_do }, dont: { caption: "A muted gray pill reads as static metadata, so live state shown as a secondary badge looks inert and goes unnoticed.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", alignItems: \"center\", gap: 6 }}>\n  <Badge secondary>active</Badge>\n  <Badge secondary>pending</Badge>\n  <Badge secondary>failed</Badge>\n</View>", render: e_atoms_badge_dont_5_dont } },
      { title: "Outline variant", do: { caption: "Use outline on a plain surface where the quiet border has contrast, for low-priority secondary tags.", code: "<Card padded>\n  <Row wrap alignCenter snug>\n    <Badge outline>draft</Badge>\n    <Badge outline>internal</Badge>\n  </Row>\n</Card>", render: e_atoms_badge_dont_6_do }, dont: { caption: "The thin border is the whole badge; on a colored or busy surface it disappears and the label floats unboxed.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", alignItems: \"center\", gap: 6, borderRadius: 6, backgroundColor: tokens.primary, padding: 12 }}>\n  <Badge outline>draft</Badge>\n  <Badge outline>internal</Badge>\n</View>", render: e_atoms_badge_dont_6_dont } },
      { title: "Destructive variant", do: { caption: "Reserve destructive for genuinely destructive or error semantics like revoked or banned.", code: "<Row wrap alignCenter snug>\n  <Badge destructive>Revoked</Badge>\n  <Badge destructive>Banned</Badge>\n  <Badge secondary>marketing</Badge>\n</Row>", render: e_atoms_badge_dont_7_do }, dont: { caption: "Solid red signals error or danger, so using it to color-code neutral categories raises a false alarm.", code: "<View style={{ flexDirection: \"row\", flexWrap: \"wrap\", alignItems: \"center\", gap: 6 }}>\n  <Badge destructive>marketing</Badge>\n  <Badge destructive>finance</Badge>\n  <Badge destructive>legal</Badge>\n</View>", render: e_atoms_badge_dont_7_dont } },
    ],
  },
  "breadcrumb": {
    dir: "breadcrumb",
    ...
    examples: [
      ...
      { label: "Separator - slash", code: "<Breadcrumb\n  items={[\"Projects\", \"Identity Platform\", \"Settings\", \"Profile\"]}\n  slash\n/>", render: e_atoms_breadcrumb_example_1 },
      { label: "Separator - dot", code: "<Breadcrumb items={[\"Projects\", \"Identity Platform\", \"Settings\", \"Profile\"]} dot />", render: e_atoms_breadcrumb_example_2 },
      { label: "Leading home icon", code: "<Breadcrumb\n  items={[\"Projects\", \"Identity Platform\", \"Settings\", \"Profile\"]}\n  chevron\n  homeIcon\n/>", render: e_atoms_breadcrumb_example_3 },
  ...
  "button": {
    ...
    category: "atoms",
    examples: [
      { label: "Default", code: "<Button primary>Save changes</Button>", render: e_atoms_button_example_0 },
      { label: "Variant - outline", code: "<Button outline>Save changes</Button>", render: e_atoms_button_example_1 },
      { label: "Variant - secondary", code: "<Button secondary>Save changes</Button>", render: e_atoms_button_example_2 },
      { label: "Variant - ghost", code: "<Button ghost>Save changes</Button>", render: e_atoms_button_example_3 },
      { label: "Variant - destructive", code: "<Button destructive>Save changes</Button>", render: e_atoms_button_example_4 },
      { label: "Variant - link", code: "<Button link>Save changes</Button>", render: e_atoms_button_example_5 },
      { label: "Size - sm", code: "<Button primary small>Save changes</Button>", render: e_atoms_button_example_6 },
      { label: "Size - lg", code: "<Button primary large>Save changes</Button>", render: e_atoms_button_example_7 },
      { label: "Size - icon", code: "<Button primary icon>+</Button>", render: e_atoms_button_example_8 },
      { label: "Disabled", code: "<Button primary disabled>Save changes</Button>", render: e_atoms_button_example_9 },
      { label: "With icon", code: "<Button primary>+  Save changes</Button>", render: e_atoms_button_example_10 },
    ],
    donts: [
  ...
  "button-group": {
    ...
    examples: [
      ...
      { label: "Variant - attached", code: "<ButtonGroup\n  stepper\n  items={[\n    \"May 21\",\n    \"May 22\",\n    \"May 23\",\n    \"Today\",\n    \"May 25\",\n    \"May 26\",\n    \"May 27\"\n  ]}\n  active={3}\n  small\n/>", render: e_atoms_button_group_example_1 },
      { label: "Variant - split", code: "<ButtonGroup\n  split\n  items={[\"Save\"]}\n  menu={[\"Save as draft\", \"Save and close\", \"Save a copy\"]}\n  small\n/>", render: e_atoms_button_group_example_2 },
      { label: "Size - default", code: "<ButtonGroup segmented defaultActive={0} items={[\"Day\", \"Week\", \"Month\"]} />", render: e_atoms_button_group_example_3 },
      { label: "Size - lg", code: "<ButtonGroup segmented defaultActive={0} items={[\"Day\", \"Week\", \"Month\"]} large />", render: e_atoms_button_group_example_4 },
  ...
  "checkbox": {
    ...
    category: "atoms",
    examples: [
      { label: "Default", code: "<Row snug alignStart>\n  <Checkbox defaultChecked />\n  <Column tight>\n    <Typography small medium>Email notifications</Typography>\n    <Typography tiny muted>Get notified when activity happens on your account.</Typography>\n  </Column>\n</Row>", render: e_atoms_checkbox_example_0 },
      { label: "State - unchecked", code: "<Row snug alignStart>\n  <Checkbox />\n  <Column tight>\n    <Typography small medium>Email notifications</Typography>\n    <Typography tiny muted>Get notified when activity happens on your account.</Typography>\n  </Column>\n</Row>", render: e_atoms_checkbox_example_1 },
      { label: "State - disabled", code: "<Row snug alignStart>\n  <Checkbox disabled />\n  <Column tight>\n    <Typography small medium>Email notifications</Typography>\n    <Typography tiny muted>Get notified when activity happens on your account.</Typography>\n  </Column>\n</Row>", render: e_atoms_checkbox_example_2 },
    ],
    donts: [
      ...
      { title: "Disabled", do: { caption: "Say why it's unavailable, like a plan gate, or don't show it at all.", code: "<Row snug alignCenter>\n  <Checkbox disabled>Export to CSV</Checkbox>\n  <Typography tiny muted>(Pro plan)</Typography>\n</Row>", render: e_atoms_checkbox_dont_2_do }, dont: { caption: "A disabled option with no reason leaves users stuck and guessing.", code: "<Checkbox disabled>Export to CSV</Checkbox>", render: e_atoms_checkbox_dont_2_dont } },
  ...
  "combobox": {
    ...
    donts: [
      ...
      { title: "Filtering", do: { caption: "Type a few letters: the list narrows as you go, so a long list stays usable.", code: "<Combobox label=\"Assigned to\" options={[\n    \"Wade Cooper\",\n    \"Arlene Mccoy\",\n    \"Devon Webb\",\n    \"Tom Cook\",\n    \"Tanya Fox\",\n    \"Hellen Schmidt\"\n  ]} defaultQuery=\"co\" defaultOpen />", render: e_atoms_combobox_dont_1_do }, dont: { caption: "Try typing: a search box that ignores input is just a dropdown wearing a costume.", code: "<View style={{ position: \"relative\", width: \"100%\", maxWidth: 280 }}>\n  <Text style={{ marginBottom: 6, fontWeight: \"500\", color: tokens.foreground, fontSize: 14, lineHeight: 20 }}>Assigned to</Text>\n  <View style={{ flexDirection: \"row\", alignItems: \"center\", justifyContent: \"space-between\", borderRadius: 6, borderWidth: 1, borderColor: tokens.input, backgroundColor: tokens.background, paddingHorizontal: 12, height: 36 }}>\n    <Text style={{ fontSize: 14, lineHeight: 20, color: tokens.foreground }}>co</Text>\n    <Text style={{ color: tokens[\"muted-foreground\"], fontSize: 14, lineHeight: 20 }}>▾</Text>\n  </View>\n  <View style={{ position: \"absolute\", top: \"100%\", left: 0, right: 0, zIndex: 50, marginTop: 4, maxHeight: 240, borderRadius: 6, borderWidth: 1, borderColor: tokens.border, backgroundColor: tokens.popover, padding: 4, ...shadow(\"lg\") }}>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Wade Cooper</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Arlene Mccoy</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Devon Webb</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Tom Cook</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Tanya Fox</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Hellen Schmidt</Text>\n    </View>\n  </View>\n</View>", render: e_atoms_combobox_dont_1_dont } },
      { title: "Selection", do: { caption: "Click an option: it fills the input and stays marked as selected.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\", \"Tom Cook\"]} defaultValue=\"Devon Webb\" defaultOpen />", render: e_atoms_combobox_dont_2_do }, dont: { caption: "Click an option: it flashes but the field stays empty, so you can't tell what you picked.", code: "<View style={{ position: \"relative\", width: \"100%\", maxWidth: 280 }}>\n  <Text style={{ marginBottom: 6, fontWeight: \"500\", color: tokens.foreground, fontSize: 14, lineHeight: 20 }}>Assigned to</Text>\n  <View style={{ flexDirection: \"row\", alignItems: \"center\", justifyContent: \"space-between\", borderRadius: 6, borderWidth: 1, borderColor: tokens.input, backgroundColor: tokens.background, paddingHorizontal: 12, height: 36 }}>\n    <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"muted-foreground\"] }}>Pick a person…</Text>\n    <Text style={{ color: tokens[\"muted-foreground\"], fontSize: 14, lineHeight: 20 }}>▾</Text>\n  </View>\n  <View style={{ position: \"absolute\", top: \"100%\", left: 0, right: 0, zIndex: 50, marginTop: 4, maxHeight: 240, borderRadius: 6, borderWidth: 1, borderColor: tokens.border, backgroundColor: tokens.popover, padding: 4, ...shadow(\"lg\") }}>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Wade Cooper</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Arlene Mccoy</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Devon Webb</Text>\n    </View>\n    <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8, borderRadius: 2, paddingHorizontal: 8, paddingVertical: 6 }}>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"], width: 14 }}> </Text>\n      <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"popover-foreground\"] }}>Tom Cook</Text>\n    </View>\n  </View>\n</View>", render: e_atoms_combobox_dont_2_dont } },
      { title: "With label", do: { caption: "A persistent label keeps the field named after a selection has filled the input.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} defaultValue=\"Devon Webb\" defaultOpen />", render: e_atoms_combobox_dont_3_do }, dont: { caption: "Once a value replaces the placeholder, an unlabeled field has nothing left to name it.", code: "<Combobox options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} defaultValue=\"Devon Webb\" defaultOpen />", render: e_atoms_combobox_dont_3_dont } },
      { title: "With helper text", do: { caption: "A short placeholder plus persistent helper text keeps the rule visible while you type.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} defaultOpen placeholder=\"Search a person…\" helperText=\"Deactivated users are hidden from the list.\" />", render: e_atoms_combobox_dont_4_do }, dont: { caption: "Type a letter: guidance crammed into the placeholder vanishes the moment you start.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} defaultOpen placeholder=\"Pick an active teammate; deactivated users are hidden\" />", render: e_atoms_combobox_dont_4_dont } },
      { title: "Disabled", do: { caption: "Show the locked value and say why it's fixed, so disabled reads as a settled choice.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} defaultValue=\"Devon Webb\" disabled helperText=\"Set by the project owner and can't be changed here.\" />", render: e_atoms_combobox_dont_5_do }, dont: { caption: "An empty, dimmed field with no value reads as broken, not as intentionally locked.", code: "<Combobox label=\"Assigned to\" options={[\"Wade Cooper\", \"Arlene Mccoy\", \"Devon Webb\"]} disabled placeholder=\"Search a person…\" />", render: e_atoms_combobox_dont_5_dont } },
    ],
  },
  "divider": {
    dir: "divider",
  ...
  "icon": {
    ...
    examples: [
      ...
      { label: "View - set", code: "<Icon set />", render: e_atoms_icon_example_1 },
      { label: "Color - primary", code: "<Icon shield size={24} primary />", render: e_atoms_icon_example_2 },
      { label: "Color - destructive", code: "<Icon shield size={24} destructive />", render: e_atoms_icon_example_3 },
      { label: "Color - muted", code: "<Icon shield size={24} muted />", render: e_atoms_icon_example_4 },
    ],
    donts: [
  ...
  "input": {
    ...
    examples: [
      ...
      { label: "Control - textarea", code: "<Input multiline placeholder=\"Describe the change\" />", render: e_atoms_input_example_1 },
      { label: "Addon - prefix", code: "<Input prefix=\"https://\" placeholder=\"canvas.dev\" />", render: e_atoms_input_example_2 },
      { label: "Addon - action", code: "<Input suffix=\"Copy\" action value=\"cnv_3f9a21b8e7\" />", render: e_atoms_input_example_3 },
      { label: "Addon - icon", code: "<Input leadingIcon icon=\"search\" placeholder=\"Search\" />", render: e_atoms_input_example_4 },
      { label: "State - error", code: "<Input error placeholder=\"rachel.chen@example.com\" />", render: e_atoms_input_example_5 },
      { label: "State - disabled", code: "<Input disabled placeholder=\"rachel.chen@example.com\" />", render: e_atoms_input_example_6 },
      { label: "State - readonly", code: "<Input readOnly placeholder=\"rachel.chen@example.com\" />", render: e_atoms_input_example_7 },
    ],
    donts: [
  ...
  "number-input": {
    ...
    category: "atoms",
    examples: [
      { label: "Default", code: "<NumberInput defaultValue={3} min={0} max={10} onChange={() => {}} />", render: e_atoms_number_input_example_0 },
      { label: "Sizes", code: "<Row alignCenter relaxed>\n  <NumberInput small defaultValue={2} min={0} max={10} onChange={() => {}} />\n  <NumberInput defaultValue={2} min={0} max={10} onChange={() => {}} />\n  <NumberInput large defaultValue={2} min={0} max={10} onChange={() => {}} />\n</Row>", render: e_atoms_number_input_example_1 },
      { label: "With min / max", code: "<Row alignCenter relaxed>\n  <NumberInput defaultValue={0} min={0} max={5} onChange={() => {}} />\n  <NumberInput defaultValue={5} min={0} max={5} onChange={() => {}} />\n</Row>", render: e_atoms_number_input_example_2 },
      { label: "Stepped", code: "<NumberInput defaultValue={20} min={0} max={100} step={10} onChange={() => {}} />", render: e_atoms_number_input_example_3 },
      { label: "Disabled", code: "<NumberInput disabled defaultValue={4} min={0} max={10} onChange={() => {}} />", render: e_atoms_number_input_example_4 },
    ],
    donts: [
      { title: "Bounds", do: { caption: "Set `min` and `max` so the buttons disable at the edges and the value can never leave the valid range.", code: "<Column snug>\n  <Typography small medium>Quantity</Typography>\n  <NumberInput defaultValue={1} min={1} max={9} onChange={() => {}} />\n</Column>", render: e_atoms_number_input_dont_0_do }, dont: { caption: "Leaving the range unbounded lets the user push the count below zero or past what the form can accept.", code: "<NumberInput defaultValue={1} onChange={() => {}} />", render: e_atoms_number_input_dont_0_dont } },
      { title: "Step", do: { caption: "Match `step` to the real increment, so each tap moves the value by an amount that makes sense for the field.", code: "<NumberInput defaultValue={30} min={0} max={120} step={5} onChange={() => {}} />", render: e_atoms_number_input_dont_1_do }, dont: { caption: "A step of 1 on a field that only takes round numbers makes the user tap many times to reach a usable value.", code: "<NumberInput defaultValue={30} min={0} max={120} step={1} onChange={() => {}} />", render: e_atoms_number_input_dont_1_dont } },
    ],
  },
  "pagination": {
    dir: "pagination",
  ...
  "progress": {
    ...
    donts: [
      { title: "Determinate", do: { caption: "Use a determinate bar when you know the share of work done, and pair it with a percent or count so the number and the bar agree.", code: "<Column snug style={{ maxWidth: 320 }}>\n  <Row flush between>\n    <Typography small>Uploading…</Typography>\n    <Typography small muted>72%</Typography>\n  </Row>\n  <Progress value={0.72} />\n</Column>", render: e_atoms_progress_dont_0_do }, dont: { caption: "Don't park a determinate bar at a hard-coded value as a decorative divider; a frozen fill reads as a stalled task.", code: "<View style={{ maxWidth: 320, gap: 8 }}>\n  <Text style={{ fontSize: 14, lineHeight: 20, color: tokens.foreground }}>Section</Text>\n  <Progress value={0.5} />\n</View>", render: e_atoms_progress_dont_0_dont } },
      { title: "Indeterminate", do: { caption: "Reach for the indeterminate bar only when the duration is genuinely unknown, so the looping sweep tells users work is happening.", code: "<Column snug style={{ maxWidth: 320 }}>\n  <Typography small muted>Connecting…</Typography>\n  <Progress indeterminate />\n</Column>", render: e_atoms_progress_dont_1_do }, dont: { caption: "Don't fake indeterminate progress when you do have a measurable value; a sliding bar over known work hides information you could show.", code: "<View style={{ maxWidth: 320, gap: 8 }}>\n  <Text style={{ fontSize: 14, lineHeight: 20, color: tokens[\"muted-foreground\"] }}>Step 3 of 4</Text>\n  <Progress indeterminate />\n</View>", render: e_atoms_progress_dont_1_dont } },
      { title: "Context", do: { caption: "Give the bar a width and a label; on its own it carries no meaning, so set its measure with the `style` prop and name the task.", code: "<Column snug style={{ maxWidth: 320 }}>\n  <Typography small>Importing contacts</Typography>\n  <Progress value={0.35} />\n</Column>", render: e_atoms_progress_dont_2_do }, dont: { caption: "Don't hand-roll a bar from raw views; the kit's `Progress` already adapts its thickness and ends per platform and stays themed.", code: "<View style={{ maxWidth: 320, height: 8, borderRadius: 4, backgroundColor: alpha(tokens.primary, 0.2), overflow: \"hidden\" }}>\n  <View style={{ height: \"100%\", width: \"35%\", borderRadius: 4, backgroundColor: tokens.primary }} />\n</View>", render: e_atoms_progress_dont_2_dont } },
    ],
  },
  "qrcode": {
    dir: "qrcode",
  ...
  "radio": {
    ...
    examples: [
      ...
      { label: "Variant - inline", code: "<Radio checked small>Pro, for growing teams that need more control.</Radio>", render: e_atoms_radio_example_1 },
      { label: "Variant - card", code: "<Row snug>\n  <Column fill>\n    <Card padded>\n      <Column snug>\n        <Radio />\n        <Typography small semibold>Hobby</Typography>\n        <Typography tiny muted>For personal projects and experiments.</Typography>\n      </Column>\n    </Card>\n  </Column>\n  <Column fill>\n    <Card padded selected>\n      <Column snug>\n        <Radio checked />\n        <Typography small semibold>Pro</Typography>\n        <Typography tiny muted>For growing teams that need more control.</Typography>\n      </Column>\n    </Card>\n  </Column>\n  <Column fill>\n    <Card padded>\n      <Column snug>\n        <Radio />\n        <Typography small semibold>Enterprise</Typography>\n        <Typography tiny muted>Advanced security, compliance, and support.</Typography>\n      </Column>\n    </Card>\n  </Column>\n</Row>", render: e_atoms_radio_example_2 },
    ],
    donts: [
      { do: { caption: "Pre-select a sensible default so the common path needs no clicks.", code: "<Column snug>\n  <Typography small semibold>Plan</Typography>\n  <RadioGroup defaultValue=\"pro\">\n    <Radio value=\"hobby\">Hobby</Radio>\n    <Radio value=\"pro\">Pro</Radio>\n    <Radio value=\"enterprise\">Enterprise</Radio>\n  </RadioGroup>\n</Column>", render: e_atoms_radio_dont_0_do }, dont: { caption: "Leaving a radio group with nothing selected forces an extra decision and can submit empty.", code: "<View style={{ flexDirection: \"column\", gap: 8 }}>\n  <Text style={{ marginBottom: 4, fontSize: 14, lineHeight: 20, fontWeight: \"600\", color: tokens.foreground }}>Plan</Text>\n  <Radio>Hobby</Radio>\n  <Radio>Pro</Radio>\n  <Radio>Enterprise</Radio>\n</View>", render: e_atoms_radio_dont_0_dont } },
      { title: "Stacked", do: { caption: "Align the control to the first text line so it sits beside the title, with the description flowing below.", code: "<Column snug>\n  <Row snug alignStart>\n    <Radio checked />\n    <Column>\n      <Typography small medium>Pro</Typography>\n      <Typography tiny muted>For growing teams that need more control.</Typography>\n    </Column>\n  </Row>\n</Column>", render: e_atoms_radio_dont_1_do }, dont: { caption: "Center-aligning the control floats it to the vertical middle of a two-line label, leaving it visually unattached to the title it controls.", code: "<View style={{ flexDirection: \"column\", gap: 10 }}>\n  <View style={{ flexDirection: \"row\", alignItems: \"center\", gap: 8 }}>\n    <Radio checked />\n    <View>\n      <Text style={{ fontSize: 13, fontWeight: \"500\", color: tokens.foreground }}>Pro</Text>\n      <Text style={{ fontSize: 12, lineHeight: 16, color: tokens[\"muted-foreground\"] }}>For growing teams that need more control.</Text>\n    </View>\n  </View>\n</View>", render: e_atoms_radio_dont_1_dont } },
  ...
  "scroll-view": {
    ...
    category: "atoms",
    examples: [
      { label: "Default", code: "<ScrollView style={{ height: 140, width: 260, borderRadius: 10, borderWidth: 1, borderColor: tokens.border }} contentContainerStyle={{ padding: 12, gap: 8 }}>\n  <View style={{ height: 36, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ height: 36, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ height: 36, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ height: 36, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ height: 36, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n</ScrollView>", render: e_atoms_scroll_view_example_0 },
      { label: "Horizontal", code: "<ScrollView horizontal style={{ width: 260, borderRadius: 10, borderWidth: 1, borderColor: tokens.border }} contentContainerStyle={{ padding: 12, gap: 8 }}>\n  <View style={{ width: 80, height: 60, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ width: 80, height: 60, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ width: 80, height: 60, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n  <View style={{ width: 80, height: 60, borderRadius: 6, backgroundColor: alpha(tokens.primary, 0.15) }} />\n</ScrollView>", render: e_atoms_scroll_view_example_1 },
    ],
    donts: [
  ...
  "select": {
    ...
    donts: [
      ...
      { title: "sm", do: { caption: "Keep the small select inline with a short label so it stays compact inside toolbars and table footers.", code: "<Row alignCenter snug>\n  <Typography tiny muted>Rows</Typography>\n  <Select small defaultValue=\"10\" options={[\"10\", \"25\", \"50\"]} style={{ width: \"auto\" }} />\n</Row>", render: e_atoms_select_dont_2_do }, dont: { caption: "A stacked block label towers over the small control and breaks the dense row it belongs in.", code: "<Select small narrow label=\"Rows per page\" defaultValue=\"10\" options={[\"10\", \"25\", \"50\"]} />", render: e_atoms_select_dont_2_dont } },
  ...
  "slider": {
    ...
    examples: [
      ...
      { label: "Size - sm", code: "<Slider small defaultValue={40} style={{ maxWidth: 280 }} />", render: e_atoms_slider_example_1 },
      { label: "Size - lg", code: "<Slider large defaultValue={75} style={{ maxWidth: 280 }} />", render: e_atoms_slider_example_2 },
      { label: "Stepped", code: "<Slider defaultValue={6} min={0} max={10} step={2} style={{ maxWidth: 280 }} />", render: e_atoms_slider_example_3 },
      { label: "Disabled", code: "<Slider disabled defaultValue={30} style={{ maxWidth: 280 }} />", render: e_atoms_slider_example_4 },
    ],
    donts: [
      { title: "Range", do: { caption: "Give the track room to breathe so the thumb has a clear travel path and the value reads at a glance.", code: "<Column snug style={{ maxWidth: 320 }}>\n  <Typography small medium>Volume</Typography>\n  <Slider defaultValue={65} min={0} max={100} />\n</Column>", render: e_atoms_slider_dont_0_do }, dont: { caption: "Cramming the slider into a tiny width leaves no travel, so the thumb can barely move and the value is hard to set.", code: "<View style={{ width: 64 }}>\n  <Slider defaultValue={65} min={0} max={100} />\n</View>", render: e_atoms_slider_dont_0_dont } },
      { title: "Bounds", do: { caption: "Pair the slider with its current value so the number is explicit, not just inferred from the thumb position.", code: "<Row alignCenter relaxed style={{ maxWidth: 320 }}>\n  <Column fill>\n    <Slider defaultValue={48} min={0} max={100} />\n  </Column>\n  <Typography small muted style={{ minWidth: 32, textAlign: \"right\" }}>48</Typography>\n</Row>", render: e_atoms_slider_dont_1_do }, dont: { caption: "A slider with no readout and no label leaves users guessing what the value is and what it controls.", code: "<Slider defaultValue={48} min={0} max={100} style={{ maxWidth: 320 }} />", render: e_atoms_slider_dont_1_dont } },
  ...
  "spinner": {
    ...
    donts: [
      { do: { caption: "Pair longer waits with a short label so the spinner has context.", code: "<Row alignCenter snug>\n  <Spinner small />\n  <Typography small muted>Loading…</Typography>\n</Row>", render: e_atoms_spinner_dont_0_do }, dont: { caption: "A bare spinner with no label leaves users guessing what is happening and for how long.", code: "<Spinner />", render: e_atoms_spinner_dont_0_dont } },
  ...
  "switch": {
    ...
    examples: [
      ...
      { label: "State - off", code: "<Switch>Available to chat</Switch>", render: e_atoms_switch_example_1 },
  ...
  "tooltip": {
    ...
    examples: [
      ...
      { label: "Side - right", code: "<Tooltip label=\"Open settings\" iconTrigger trigger=\"Hover me\" open right />", render: e_atoms_tooltip_example_1 },
      { label: "Side - bottom", code: "<Tooltip label=\"Open settings\" iconTrigger trigger=\"Hover me\" open bottom />", render: e_atoms_tooltip_example_2 },
      { label: "Side - left", code: "<Tooltip label=\"Open settings\" iconTrigger trigger=\"Hover me\" open left />", render: e_atoms_tooltip_example_3 },
      { label: "Trigger - button", code: "<Tooltip label=\"Open settings\" trigger=\"Hover me\" open top />", render: e_atoms_tooltip_example_4 },
      { label: "Trigger - text", code: "<Tooltip label=\"Open settings\" trigger=\"hover this text\" open top />", render: e_atoms_tooltip_example_5 },
      { label: "Reveal - on hover", code: "<Tooltip label=\"Open settings\" iconTrigger trigger=\"Hover me\" top />", render: e_atoms_tooltip_example_6 },
    ],
    donts: [
  ...
  "typography": {
    ...
    examples: [
      ...
      { label: "Style - display", code: "<Typography display>The quick brown fox</Typography>", render: e_atoms_typography_example_1 },
      { label: "Style - h2", code: "<Typography h2>The quick brown fox</Typography>", render: e_atoms_typography_example_2 },
      { label: "Style - h3", code: "<Typography h3>The quick brown fox</Typography>", render: e_atoms_typography_example_3 },
      { label: "Style - h4", code: "<Typography h4>The quick brown fox</Typography>", render: e_atoms_typography_example_4 },
      { label: "Style - h5", code: "<Typography h5>The quick brown fox</Typography>", render: e_atoms_typography_example_5 },
      { label: "Style - body", code: "<Typography body>The quick brown fox</Typography>", render: e_atoms_typography_example_6 },
      { label: "Style - small", code: "<Typography small>The quick brown fox</Typography>", render: e_atoms_typography_example_7 },
      { label: "Style - tiny", code: "<Typography tiny>The quick brown fox</Typography>", render: e_atoms_typography_example_8 },
      { label: "Style - muted", code: "<Typography muted>The quick brown fox</Typography>", render: e_atoms_typography_example_9 },
  ...
  "alert": {
    ...
    category: "molecules",
    examples: [
      { label: "Default", code: "<Alert\n  info\n  icon=\"ℹ\"\n  title=\"Heads up\"\n  description=\"Maintenance window scheduled for Sunday 2:00 UTC.\"\n  dismissible\n>\n  <Row snug>\n    <Button link small>Learn more</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_example_0 },
      { label: "Variant - success", code: "<Alert\n  success\n  icon=\"✓\"\n  title=\"All set\"\n  description=\"Your changes have been saved successfully.\"\n  dismissible\n>\n  <Row snug>\n    <Button ghost small>View changes</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_example_1 },
      { label: "Variant - warning", code: "<Alert\n  warning\n  icon=\"⚠\"\n  title=\"Action required\"\n  description=\"Your trial expires in 3 days.\"\n  dismissible\n>\n  <Row snug>\n    <Button primary small>Upgrade plan</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_example_2 },
      { label: "Variant - destructive", code: "<Alert\n  error\n  icon=\"✕\"\n  title=\"Something went wrong\"\n  description=\"Could not save your changes. Please try again.\"\n  dismissible\n>\n  <Row snug>\n    <Button primary small>Retry</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_example_3 },
    ],
    donts: [
      { title: "info", do: { caption: "Reserve info for passive, non-urgent context (notices, tips); escalate to warning or destructive when action is required.", code: "<Alert info icon=\"ℹ\" title=\"Heads up\" description=\"Maintenance window scheduled for Sunday 2:00 UTC.\" />", render: e_molecules_alert_dont_0_do }, dont: { caption: "Dressing an act-now message in the neutral info tone hides the urgency; users skim past it like an FYI.", code: "<Alert info icon=\"ℹ\" title=\"Trial expires today\" description=\"Upgrade now or you'll lose access to your projects.\" />", render: e_molecules_alert_dont_0_dont } },
      { title: "success", do: { caption: "Make confirmations transient: auto-dismiss or give a Dismiss control so the success state clears once acknowledged.", code: "<Alert success icon=\"✓\" title=\"Saved\" description=\"Your changes have been saved successfully.\">\n  <Row snug>\n    <Button ghost small>Dismiss</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_dont_1_do }, dont: { caption: "A success banner pinned with no way to dismiss it lingers as visual noise long after the action is done.", code: "<Alert success icon=\"✓\" title=\"Saved\" description=\"Your changes have been saved successfully.\" />", render: e_molecules_alert_dont_1_dont } },
      { title: "warning", do: { caption: "State the consequence, the deadline, and the action: name what's wrong and give a button to resolve it.", code: "<Alert warning icon=\"⚠\" title=\"Action required\" description=\"Your trial expires in 3 days. Upgrade to keep your projects.\">\n  <Row snug>\n    <Button primary small>Upgrade plan</Button>\n  </Row>\n</Alert>", render: e_molecules_alert_dont_2_do }, dont: { caption: "A warning with no specifics or next step leaves the user guessing what to fix and by when.", code: "<Alert warning icon=\"⚠\" title=\"Action required\" description=\"Something needs your attention.\" />", render: e_molecules_alert_dont_2_dont } },
  ...
  "empty-state": {
    ...
    donts: [
      { title: "search", do: { caption: "State the result neutrally and point at the lever the user can pull (filters, query).", code: "<EmptyState bordered icon=\"🔍\" title=\"No results found\" description=\"Try adjusting your search filters.\" />", render: e_molecules_empty_state_dont_0_do }, dont: { caption: "Blaming the searcher for an empty result set makes a normal outcome feel like a mistake.", code: "<EmptyState bordered icon=\"🔍\" title=\"Nothing matched\" description=\"You searched for the wrong thing. Check your spelling and try again.\" />", render: e_molecules_empty_state_dont_0_dont } },
      { title: "users", do: { caption: "When the user can fix it, give them the one action that does (Invite, Create).", code: "<EmptyState bordered icon=\"👥\" title=\"No users\" description=\"Invite your first team member.\" actionLabel=\"Invite member\" />", render: e_molecules_empty_state_dont_1_do }, dont: { caption: "A dead-end that only restates the emptiness leaves the user with nowhere to go.", code: "<EmptyState bordered icon=\"👥\" title=\"No users\" description=\"There are no team members in this workspace.\" />", render: e_molecules_empty_state_dont_1_dont } },
      { title: "files", do: { caption: "Name the gesture that fills the empty space so the next step is obvious.", code: "<EmptyState bordered icon=\"📄\" title=\"No files\" description=\"Upload or drag files here.\" />", render: e_molecules_empty_state_dont_2_do }, dont: { caption: "Generic 'nothing here' copy never tells the user how files would get into the folder.", code: "<EmptyState bordered icon=\"📄\" title=\"Nothing here\" description=\"This folder is empty.\" />", render: e_molecules_empty_state_dont_2_dont } },
      { title: "activity", do: { caption: "Keep a routinely-empty state calm: muted icon, reassuring copy, no urgency.", code: "<EmptyState bordered icon=\"📈\" title=\"No activity\" description=\"Events will appear as they happen.\" />", render: e_molecules_empty_state_dont_3_do }, dont: { caption: "An alarming red icon turns a calm, expected empty feed into a false error.", code: "<View style={{ alignItems: \"center\", borderRadius: 8, borderWidth: 1, borderColor: tokens.border, paddingHorizontal: 24, paddingVertical: 32 }}>\n  <View style={{ marginBottom: 12, height: 48, width: 48, alignItems: \"center\", justifyContent: \"center\", borderRadius: 9999, backgroundColor: alpha(tokens.destructive, 0.1) }}>\n    <Text style={{ fontSize: 20, lineHeight: 28, color: tokens.destructive }}>⚠️</Text>\n  </View>\n  <Text style={{ textAlign: \"center\", fontSize: 16, lineHeight: 24, fontWeight: \"600\", color: tokens.foreground }}>No activity</Text>\n  <Text style={{ marginTop: 4, textAlign: \"center\", fontSize: 14, lineHeight: 20, color: tokens[\"muted-foreground\"] }}>Events will appear as they happen.</Text>\n</View>", render: e_molecules_empty_state_dont_3_dont } },
      { title: "notifications", do: { caption: "Celebrate a cleared queue: 'All caught up' reads as success, not absence.", code: "<EmptyState bordered icon=\"🔔\" title=\"All caught up\" description=\"No new notifications.\" />", render: e_molecules_empty_state_dont_4_do }, dont: { caption: "Apologetic, sad-toned copy frames an inbox-zero win as a letdown.", code: "<EmptyState bordered icon=\"🔔\" title=\"Nothing to see\" description=\"You have no notifications. Sorry, it's quiet in here.\" />", render: e_molecules_empty_state_dont_4_dont } },
      { title: "errors", do: { caption: "Signal the good news with a green check: zero errors is a passing state, not an empty one.", code: "<EmptyState bordered positive icon=\"✅\" title=\"No errors\" description=\"Everything is running smoothly.\" />", render: e_molecules_empty_state_dont_5_do }, dont: { caption: "A grey 'nothing found' disc reads as a failed query, not as a healthy, error-free system.", code: "<EmptyState bordered icon=\"🔍\" title=\"No errors\" description=\"Nothing was found.\" />", render: e_molecules_empty_state_dont_5_dont } },
      { title: "all-clear", do: { caption: "Reserve the green all-clear for genuinely empty queues: nothing locked, nothing waiting.", code: "<EmptyState bordered positive icon=\"✅\" title=\"All clear\" description=\"No locked accounts or pending reviews.\" />", render: e_molecules_empty_state_dont_6_do }, dont: { caption: "A green all-clear over copy that admits work is pending hides the action the user must take.", code: "<EmptyState bordered positive icon=\"✅\" title=\"No pending reviews\" description=\"3 accounts are locked and waiting on you.\" />", render: e_molecules_empty_state_dont_6_dont } },
    ],
  },
  "feeds": {
    dir: "feeds",
  ...
  "tabs": {
    ...
    examples: [
      ...
      { label: "Variant - pill", code: "<Tabs pills tabs={[\"All\", \"Active\", \"Archived\", \"Deleted\"]} defaultActive={0} />", render: e_organisms_tabs_example_1 },
      { label: "Variant - vertical", code: "<Tabs\n  vertical\n  tabs={[\"General\", \"Security\", \"Notifications\", \"API Keys\", \"Billing\"]}\n  defaultActive={0}\n/>", render: e_organisms_tabs_example_2 },

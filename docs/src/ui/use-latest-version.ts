...
// The version pill shows the latest PUBLISHED release of @nannier-com/canvas. It re-checks the
...
const LATEST_URL = "https://registry.npmjs.org/@nannier-com/canvas/latest";

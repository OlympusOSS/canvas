...
export const ATOMS_TILES: CatTile[] = [
  ...
  { title: "Text Input", href: "/components/text-input", Preview: TextInputPreview },
  { title: "Scroll View", href: "/components/scroll-view", Preview: ScrollViewPreview },
  { title: "Avatars", href: "/components/avatar", Preview: AvatarsPreview },
  { title: "Badges", href: "/components/badge", Preview: BadgesPreview },
  { title: "Breadcrumbs", href: "/components/breadcrumb", Preview: BreadcrumbsPreview },
  { title: "Button Groups", href: "/components/button-group", Preview: ButtonGroupsPreview },
  { title: "Buttons", href: "/components/button", Preview: ButtonsPreview },
  { title: "Checkboxes", href: "/components/checkbox", Preview: CheckboxesPreview },
  { title: "Comboboxes", href: "/components/combobox", Preview: ComboboxesPreview },
  { title: "Dividers", href: "/components/divider", Preview: DividersPreview },
  { title: "Dropdowns", href: "/components/dropdown", Preview: DropdownsPreview },
  { title: "Icons", href: "/components/icon", Preview: IconsPreview },
  { title: "Inputs & Forms", href: "/components/input", Preview: InputsFormsPreview },
  { title: "Pagination", href: "/components/pagination", Preview: PaginationPreview },
  { title: "Radios", href: "/components/radio", Preview: RadiosPreview },
  { title: "Selects", href: "/components/select", Preview: SelectsPreview },
  { title: "Skeletons", href: "/components/skeleton", Preview: SkeletonsPreview },
  { title: "Textareas", href: "/components/textarea", Preview: TextareasPreview },
  { title: "Toggles", href: "/components/toggle", Preview: TogglesPreview },
  { title: "Tooltips", href: "/components/tooltip", Preview: TooltipsPreview },
];
